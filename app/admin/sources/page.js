    ...
    <section className="panel">
      <div className="panel-header">
        <div>
          ...
          <h2 className="panel-title">{result.summary?.eventCount ?? 0} candidates returned</h2>
        </div>
        <div className="summary-chips">
          <span className="chip">{result.ran} source{result.ran === 1 ? '' : 's'}</span>
          <span className="chip">{result.summary?.errorCount ?? 0} errors</span>
          <span className="chip">{result.summary?.fallbackCount ?? 0} fallbacks</span>
        </div>
      </div>
    ...
    <main className="admin-shell">
      <div className="admin-wrap">
        <header className="adash-header">
          ...
          <div className="adash-header-right"><span className="admin-pill">source runners</span></div>
        </header>
        ...
        <section className="panel">
          ...
          <div className="panel-sub">Run the first source fetchers and inspect normalized candidate output before review.</div>
